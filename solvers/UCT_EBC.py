...
def Trial(s, s_goal, option):
    ...
    if CheckGoal(s, s_goal): return 0               # No cost to reach the goal
    elif not s.actions: return K          # Penalty for dead-ends
    ...
    if successor == s :
        ...
        QvaluePrime =  cost + Trial(successor, s_goal, option)  
...
"""
def UCT_adativeCoefficient(s0, s_goal, maxTrials, option):
