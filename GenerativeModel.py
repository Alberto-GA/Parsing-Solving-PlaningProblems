...
#directory1 = r'C:\Users\alber\Documents\ISAE-MAE\Research project\MyAlgorithms\learning2parse\ppddl\crossing_traffic_inst_mdp\p4\Domain.ppddl'
#directory2 = r'C:\Users\alber\Documents\ISAE-MAE\Research project\MyAlgorithms\learning2parse\ppddl\crossing_traffic_inst_mdp\p4\p04.ppddl'
...
#directory1 = r'C:\Users\alber\Documents\ISAE-MAE\Research project\MyAlgorithms\learning2parse\ppddl\sysadmin_inst_mdp\p1\Domain.ppddl'
#directory2 = r'C:\Users\alber\Documents\ISAE-MAE\Research project\MyAlgorithms\learning2parse\ppddl\sysadmin_inst_mdp\p1\p01.ppddl'

#directory1 = r'C:\Users\alber\Documents\ISAE-MAE\Research project\MyAlgorithms\learning2parse\ppddl\navigation_inst_mdp\p2\Domain.ppddl'
#directory2 = r'C:\Users\alber\Documents\ISAE-MAE\Research project\MyAlgorithms\learning2parse\ppddl\navigation_inst_mdp\p2\p02.ppddl'
...
#directory1 = r'C:\Users\alber\Documents\ISAE-MAE\Research project\MyAlgorithms\learning2parse\ppddl\skill_teaching_inst_mdp\p1\Domain.ppddl'
#directory2 = r'C:\Users\alber\Documents\ISAE-MAE\Research project\MyAlgorithms\learning2parse\ppddl\skill_teaching_inst_mdp\p1\p01.ppddl'
...
def CheckGoal(s1):
    ...
    ----------
    s1 : State object
        This is the state that will be compared with the goal of the problem

    Returns
    -------
    rv : bool
        True whenever all the predicates of the goal are also true in s1
        predicates. Otherwise False
...
def Cost(state):
    ...
    ----------
    state : State object
        This is the successor s' sampled from the chance node (s,a). 

    Returns
    -------
    goalcost/ DeadEndCost / nominalCost
    
    This functio will be called solely if we are working with goal-oriented
    problems such as Stochastic Shortest Path problems
...
class State:
    ...
    def SampleChild(self, action):
        ...
        # Define the remaining decision steps
        child.set_remaining_steps(self.remaining_steps - 1)
    ...
    def __str__(self):
        return str(self.predicates)+ ' - ' + str(self.remaining_steps)
#-----------------------------------------------------------------------------
